...
class Incident 
{
	...
	public static function one($id)
	{
		...
		$sql ='SELECT i.`id`, i.`objet_incident`, i.`etat`, i.`description_incident`,i.`solution_incident`, 
		i.`date_signalement`, i.`date_intervention`, i.`niveau_urgence`, i.`niveau_complexite`, i.`duree`, i.`nb_appels`,
		e.`intitule_etat`,
		m.`id` AS `id_materiel`, m.`type` AS `type_materiel`, m.`modele`AS `modele_materiel`,m.`marque`AS `marque_materiel`,
